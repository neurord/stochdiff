 ...
 */
public class Poisson implements BinomialLike {
    ...
    public int nextInt(double theMean) {
        ...
        if (my < SWITCH_MEAN) { // CASE B: Inversion- start new table and calculate p0
            ...
            m = (my > 1.0) ? (int)my : 1;
            for(;;) {
                u = this.randomGenerator.random();           // Step U. Uniform sample
                k = 0;
                if (u <= p0) return(k);
            ...
            for (;;) {
                ...
                if ((U = this.randomGenerator.random() * p6) < p2) {         // centre left
                    ...
                    Dk = (int)(dl * this.randomGenerator.random()) + 1;
                    ...
                    // either squeeze-acceptance of X or acceptance-rejection of Y
                    Dk = (int)(dr * this.randomGenerator.random()) + 1;
